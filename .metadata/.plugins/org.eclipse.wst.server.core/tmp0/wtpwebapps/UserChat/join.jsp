...
<body>
	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			<button type="collapse" class="navbar-toggle collapsed"
		...
		<div class="container">
			<form method="post" action="./userRegister"></form>
				<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							<td sytle="width: 110px;"><h5>아이디</h5>
						...
						<tr>
							<td sytle="width: 110px;"><h5>비밀번호</h5>
						...
						<tr>
							<td sytle="width: 110px;"><h5>비밀번호 확인</h5>
						...
						<tr>
							<td sytle="width: 110px;"><h5>이메일</h5>
		...
		<div class="modal fade" id="checkModal" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="vertical-alignment-helper">
				<div class="modal-dialog vertical-align-center">
					<div id="checkType" class="modal-content pannel-info">
						<div class="modal-header panel-heading">
							<button type="button" class="close" data-dismiss="modal">
								<span aria-hidden="true">&times</span>
								<span class="sr-only">Close</span>								
